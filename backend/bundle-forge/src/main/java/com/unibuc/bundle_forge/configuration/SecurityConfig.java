...
import com.unibuc.bundle_forge.security.JWTFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET, "/top-sellers").permitAll()
                        .requestMatchers(HttpMethod.GET, "/coupons/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/payment/webhook/stripe").permitAll()
